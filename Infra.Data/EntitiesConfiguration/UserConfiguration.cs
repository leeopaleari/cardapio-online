...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(x => x.PasswordHash).HasColumnName("DS_PASSWORD_HASH");
        builder.Property(x => x.PasswordSalt).HasColumnName("DS_PASSWORD_SALT");
        builder.Property(x => x.Phone).HasColumnName("DS_PHONE").HasMaxLength(11);
        builder.Property(x => x.BirthDate).HasColumnName("DT_BIRTHDATE");
    }
}